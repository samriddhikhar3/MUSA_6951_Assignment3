...
ggplot(acsTractsPHL.2016)+
  ...
  labs(
    title = "Philadelphia Median Income by Census Tract, 2016 and 2020",
...
If I had more time I would include more graphs to further illustrate the relationship between demographic shifts and gentrification with more information on UCD. The github repository with all necessary data is located (here.)[sss]
